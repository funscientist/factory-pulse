    ...
    <SlideLayout slideNumber={1} totalSlides={9} variant="hero">
      <div className="flex flex-col justify-center h-full">
        ...
        <div className="max-w-5xl">
          ...
          {/* Key flow */}
          <div className="flex items-center gap-4 p-5 rounded-xl bg-white/10 backdrop-blur-sm border border-white/10 max-w-3xl mb-8 fade-in-up stagger-3">
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-lg bg-white/20">
                <Database className="w-5 h-5 text-white" />
              </div>
              <span className="text-white font-medium">보안 데이터</span>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-white font-medium">증거(Evidence)</span>
            </div>
            <ArrowRight className="w-5 h-5 text-white/60" />
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-lg bg-white/20">
              ...
              <span className="text-white font-bold">대응(Action)</span>
            </div>
          </div>
