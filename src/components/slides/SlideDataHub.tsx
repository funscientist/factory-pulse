  ...
  return (
    <SlideLayout slideNumber={7} totalSlides={12} category="Product" variant="gray">
      <div className="flex flex-col justify-center h-full min-h-[80vh]">
        <div className="mb-10">
          <span className="badge badge-info mb-4 fade-in-up">Layer 1: Data Infrastructure</span>
        ...
        {/* Why section */}
        <div className="p-6 rounded-xl border-l-4 border-primary bg-blue-50 max-w-4xl mb-8 fade-in-up stagger-3">
          <div className="flex items-start gap-4">
            <AlertCircle className="w-6 h-6 text-primary shrink-0 mt-0.5" />
            <div>
              <h3 className="text-h4 text-foreground mb-2">왜 1단계가 데이터 통합인가?</h3>
        ...
        {/* Quick start option */}
        <div className="flex items-center gap-4 p-5 rounded-xl bg-card border border-dashed border-border shadow-sm max-w-5xl fade-in-up stagger-5">
