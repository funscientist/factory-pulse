  ...
  return (
    <SlideLayout slideNumber={6} totalSlides={12} category="Solution">
      <div className="flex flex-col justify-center h-full min-h-[80vh]">
        <div className="mb-10">
          <span className="badge badge-info mb-4 fade-in-up">End-to-End Workflow</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl">
          ...
          <div className="space-y-3">
            {steps.map((item, index) => (
              <div key={index} className={`relative fade-in-up stagger-${index + 2}`}>
                <div className="flex items-start gap-4 p-5 rounded-xl bg-card shadow-card hover:shadow-card-hover transition-all duration-300">
                  <div className="flex flex-col items-center">
                    <span className="text-tiny font-bold text-primary mb-2">{item.step}</span>
                  ...
                  <div className="flex-1">
                    <h3 className="text-h4 text-foreground mb-1">{item.title}</h3>
          ...
          <div className="space-y-4 fade-in-up stagger-5">
            <h3 className="text-h3 text-foreground mb-4">대시보드 출력</h3>
            ...
            <div className="card-base">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="text-h4 text-foreground">경영진 Dashboard</p>
                  <p className="text-tiny text-muted-foreground">Executive Decision Support</p>
                </div>
              </div>
              <ul className="space-y-2 text-small text-muted-foreground ml-12">
            ...
            <div className="card-base">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="text-h4 text-foreground">현장 Dashboard</p>
                  <p className="text-tiny text-muted-foreground">Operational KPIs</p>
                </div>
              </div>
              <ul className="space-y-2 text-small text-muted-foreground ml-12">
                <li className="flex items-center gap-2">
